...
<body>
    ...
    <div class="container">
      <nav class="navbar navbar-inverse" role="navigation">
        <div class="navbar-header">
          ...
          <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><img src="images/kog-logo.png" alt="banner" />
          </a> </div>
        <!--/.navbar-header-->
    ...
    <div class="banner-container"> <img src="images/banner-bg.jpg" alt="banner" />
      <div class="container banner-content">
        <div class="hero-text animated fadeInDownBig">
          <h1 class="responsive-headline" style="font-size: 40px;">Show Love In MUSIC<br />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div id="owl-demo" class="owl-carousel">
              <div class="item"> <span class="helper"> <img src="images/clients/1.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/2.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/3.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/4.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/5.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/6.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/7.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/8.png" alt="client" /></span> </div>
              <div class="item"> <span class="helper"> <img src="images/clients/9.png" alt="client" /></span> </div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div id="portfolio">
            ...
            <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
              <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> <a href="images/work/1.jpg" class="fancybox"> <img src="images/work/1.jpg" alt="">
                  <div class="overlay"> <span>Amin Single</span> </div>
                </a> </li>
              <li class="item photography" style="position: absolute; left: 292px; top: 0px;"> <a href="images/work/2.jpg" class="fancybox"> <img src="images/work/2.jpg" alt="">
                  <div class="overlay"> <span>KOG Studio</span> </div>
                </a> </li>
              <li class="item branding" style="position: absolute; left: 585px; top: 0px;"> <a href="images/work/3.mp4" class="fancybox"> <img src="images/work/3.jpg" alt="">
                  <div class="overlay"> <span>Mood</span> </div>
                </a> </li>
              <li class="item photography" style="position: absolute; left: 877px; top: 0px;"> <a href="images/work/4.jpg" class="fancybox"> <img src="images/work/4.jpg" alt="">
                  <div class="overlay"> <span>Lovely</span> </div>
                </a> </li>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="col">
            ...
            <ul>
              <li>Ado-Ekiti</li>
              <li>Phone: +234 8064252535 | whatsapp: +234 8064252535 </li>
              <li>Email: <a href="mailto:info@example.com" title="Email Us">info@kogstudio.com.ng</a></li>
              <li>Skype: <a href="skype:my.test?call" title="Skype us">kog</a></li>
            </ul>
          </div>
        </div>
  ...
  <section class="copyright">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text-center"> Copyright 2020 | All Rights Reserved -- echowell <a href=""></a> </div>
      </div>
      <!-- / .row -->
    </div>
  </section>
